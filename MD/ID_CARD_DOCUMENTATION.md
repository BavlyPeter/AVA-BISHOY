...
- **Church Logo:**
  ...
  - File: `AVA Bishoy church.png`
  - Import: `import churchLogo from '../../imports/AVA Bishoy church.png';`
...
```typescript
// At top of file
import churchLogo from '../../imports/AVA Bishoy church.png';
...
const logoPath = new URL('../../imports/AVA Bishoy church.png', import.meta.url).href;

// ❌ String path
<img src="../../imports/AVA Bishoy church.png" alt="Logo" />

// ❌ ?url suffix
import logo from '../../imports/AVA Bishoy church.png?url';

// ❌ require() syntax
const logo = require('../../imports/AVA Bishoy church.png');
```
...
- Error: `Failed to load: /src/imports/AVA Bishoy church.png`
