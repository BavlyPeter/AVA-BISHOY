...
- **Problem:** Church logo (`AVA Bishoy church.png`) and festival logo (`Arebsalin Logo.png`) not displaying in ID card component
...
- **Solution:** Changed to static ES module imports matching pattern in EnhancedDashboard and LoginPage
  ```typescript
  // Before (broken)
  const churchLogoPath = new URL('../../imports/AVA Bishoy church.png', import.meta.url).href;
